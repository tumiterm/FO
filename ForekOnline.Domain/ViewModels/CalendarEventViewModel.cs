// <copyright file="CalendarEventViewModel.cs" company="Forek ICT Services">
//     Copyright © Forek ICT Services.
// </copyright>
// Created By:      Itumeleng Oliphant - (on DESKTOP-72504AI)
// Created Date:    28/12/2025 13:46:27 PM
// Purpose:         Defines the CalendarEventViewModel class

namespace ForekOnline.Domain.ViewModels
{
    /// <summary>
    /// Represents the data model for a calendar event, including event details such as title, start and end
    /// </summary>
